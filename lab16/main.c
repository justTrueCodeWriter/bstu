...
int array_saver_binary(marks_t *array, char *fileName);
...
// FILL MODE
	do {
		...
		switch (userChoice) {
			...
			case 2: FileName = "src.txt";
					amountOfElements = array_reader_txt(array, FileName);	
			...
			case 3: 
					FileName = "src.bin";
					amountOfElements = array_reader_binary(array, FileName);
					if (amountOfElements == 0)
						return 0;
					break;
	...
	array_saver_binary(array, "saved.bin");
